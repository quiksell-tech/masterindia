...
use App\Models\MasterIndiaEInvoiceInwardTxn;
...
class InwardEInvoiceController extends Controller
{
    ...
    public function __construct(MasterIndiaService $masterIndiaService, MasterIndiaEInvoiceInwardTxn $masterIndiaEInvoiceTransaction)
    {
    ...
    public function getEInvoice(Request $request, MiInwardOrder $miOrder)
    {

        $order = MiInwardOrder::where('order_id', $miOrder->order_id)->get();
        if ($order->isEmpty()) {
